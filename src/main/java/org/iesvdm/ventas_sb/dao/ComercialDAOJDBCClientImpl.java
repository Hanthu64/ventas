...
public class ComercialDAOJDBCClientImpl implements ComercialDAO{
    ...
    public List<Comercial> getAll() {
        ...
        RowMapper<Comercial> rowMapperComercial = (rs, rowNum) ->
        ...
        List<Comercial> listCo = jdbcClient.sql(query)
    ...
    public void update(Comercial comercial) {
        ...
        int rowsUpdated = jdbcClient.sql(query)
                .param("nombre", comercial.getNombre())
                .param("apellido1", comercial.getApellido1())
                .param("apellido2", comercial.getApellido2())
                .param("comisión", comercial.getComision())
                .param("id", comercial.getId())
                .update();
